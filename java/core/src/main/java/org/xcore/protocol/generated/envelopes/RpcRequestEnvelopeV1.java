...
public record RpcRequestEnvelopeV1(
        String message_type,
        int message_version,
        String message_id,
    ...
    public static final String MESSAGE_KIND = "rpc_request";
    public static final String CONTENT_TYPE = "application/json";

    public RpcRequestEnvelopeV1 {
        ...
        Objects.requireNonNull(reply_to, "reply_to must not be null");
        if (reply_to.length() < 1) {
            throw new IllegalArgumentException("reply_to must be at least 1 characters");
        }
        Objects.requireNonNull(timeout_ms, "timeout_ms must not be null");
    }
}
