...
FAMILY_CONFIGS: tuple[FamilyConfig, ...] = (
    ...
    FamilyConfig(
        name="identity",
        python_module="identity",
        java_package="org.xcore.protocol.generated.messages.identity",
        java_messages_class="IdentityMessages",
        java_routes_class="IdentityRoutes",
        includes=("identity",),
        generated_model_test="python/tests/test_generated_identity_models.py",
    ),
    FamilyConfig(
        name="server",
        python_module="server",
        java_package="org.xcore.protocol.generated.messages.server",
        java_messages_class="ServerMessages",
        java_routes_class="ServerRoutes",
        includes=("server",),
        generated_model_test="python/tests/test_generated_server_models.py",
    ),
    FamilyConfig(
        name="security",
        python_module="security",
        java_package="org.xcore.protocol.generated.messages.security",
        java_messages_class="SecurityMessages",
        java_routes_class="SecurityRoutes",
        includes=("security",),
        generated_model_test="python/tests/test_generated_security_models.py",
    ),
    FamilyConfig(
        name="discord",
    ...
    FamilyConfig(
        name="moderation",
        python_module="moderation",
        java_package="org.xcore.protocol.generated.messages.moderation",
        java_messages_class="ModerationMessages",
        java_routes_class="ModerationRoutes",
        includes=("moderation",),
